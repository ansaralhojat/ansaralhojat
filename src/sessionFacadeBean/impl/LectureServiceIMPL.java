...
public class LectureServiceIMPL extends BaseServiceIMPL<Lecture> implements LectureService{
    ...
    public Lecture findLastLecture() {
        String queryString = "select l from Lecture l left join fetch l.file left join fetch l.text order by l.id desc";
    ...
    public List<Lecture> findByCondition(String subject, int lecturer, int decorum) {
        StringBuilder queryString =  new StringBuilder(" select l from Lecture l left join fetch l.file left join fetch l.text where 1=1 ");
